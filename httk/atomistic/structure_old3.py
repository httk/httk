...
class Structure(HttkObject):  
    ...
    def create(cls,
               ...
               rc_scale=None, rc_scaling=None, rc_volume=None, volume_per_atom=None,
        ...
        if tags is not None:
            new.add_tags(tags)
            if 'uc' in other_reps:
                other_reps['uc'].add_tags(tags)
        if refs is not None:
            new.add_refs(refs)               
            if 'uc' in other_reps:
                other_reps['uc'].add_refs(refs)
        return new
    ...
    def use(cls, other):
        ...
        if isinstance(other, UnitcellStructure):
            if other.has_rc_repr:
                return other.get_symmetryfinder_rc_structure()
            else:
    ...
    def rc(self):
        if 'rc' not in self._other_reps:
            rc_struct = RepresenativeStructure.create(assignments=self.assignments, rc_cell=self.rc_cell, rc_sites=self.rc_sites)
    ...
    @property
    def cc_cartesian_occupationscoords(self):
        raise Exception("UnitcellStructure.cc_cartesian_occupationscoords: not implemented")
        return 

    @property
    def cc_cartesian_coordgroups(self):
        return self.cc.uc_cartesian_coordgroups

    @property
    def cc_cartesian_coords(self):
        return self.cc.uc_cartesian_coords

    @property
    def cc_lengths_and_angles(self):
        return [self.cc.uc_a, self.cc.uc_b, self.cc.uc_c, self.cc.uc_alpha, self.cc.uc_beta, self.cc.uc_gamma]

    @httk_typed_property(float)
    def cc_a(self):
        return self.cc.uc_cell.a

    @httk_typed_property(float)
    def cc_b(self):
        return self.cc.uc_cell.b

    @httk_typed_property(float)
    def cc_c(self):
        return self.cc.uc_cell.c

    @httk_typed_property(float)
    def cc_alpha(self):
        return self.cc.uc_cell.alpha

    @httk_typed_property(float)
    def cc_beta(self):
        return self.cc.uc_cell.beta

    @httk_typed_property(float)
    def cc_gamma(self):
        return self.cc.uc_cell.gamma

    @property
    def cc_basis(self):
        return self.cc.uc_cell.basis

    @httk_typed_property(float)
    def cc_volume(self):
        return self.cc.uc_cell.volume

    @httk_typed_property(float)
    def cc_volume_per_atom(self):
        return self.cc.uc_cell.volume/self.uc_sites.total_number_of_atoms

    @httk_typed_property(int)
    def cc_cell_orientation(self):
        return self.cc.uc_cell.orientation
    
    @property
    def cc_reduced_coordgroups(self):
        return self.cc.uc_sites.reduced_coordgroups

    @property
    def cc_reduced_coords(self):
        return self.cc.uc_reduced_coords

    @httk_typed_property([int])
    def cc_counts(self):
        return self.cc.uc_sites.counts

    @property
    def pc_cartesian_occupationscoords(self):
        raise Exception("UnitcellStructure.uc_cartesian_occupationscoords: not implemented")
        return 

    @property
    def pc_cartesian_coordgroups(self):
        return self.pc.uc_cartesian_coordgroups

    @property
    def pc_cartesian_coords(self):
        return self.pc.uc_cartesian_coords

    @property
    def pc_lengths_and_angles(self):
        return [self.pc.uc_a, self.pc.uc_b, self.pc.uc_c, self.pc.uc_alpha, self.pc.uc_beta, self.pc.uc_gamma]
    ...
    @httk_typed_property(float)
    def pc_volume_per_atom(self):
        return self.pc.uc_cell.volume/self.pc.uc_sites.total_number_of_atoms

    @httk_typed_property(int)
    def pc_cell_orientation(self):
        return self.pc.uc_cell.orientation
    
    @property
    def pc_reduced_coordgroups(self):
        return self.pc.uc_sites.reduced_coordgroups

    @property
    def pc_reduced_coords(self):
        return self.pc.uc_sites.reduced_coords
    ...
    def formula(self):
        ...
        return normalized_formula(self.cc.assignments.symbollists, self.cc.assignments.ratioslist, self.cc.uc_counts)
