...
citation.add_ext_citation('web.py', "(Author list to be added)")
...
if path is not None:
    ...
    if external == 'yes':
        ...
        raise Exception("httk.external.webpy_ext imported, but web module not found.")
