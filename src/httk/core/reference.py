...
class Reference(HttkObject):
    ...
    def __init__(self, ref, authors=[], editors=[], journal=None, journal_issue=None, journal_volume=None,
    ...
    @classmethod
    def create(cls, ref=None, authors=[], editors=[], journal=None, journal_issue=None, journal_volume=None,
               page_first=None, page_last=None, title=None, year=None, book_publisher=None,
               book_publisher_city=None, book_title=None):
        """
